...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'finding');

		$('.daterangepicker_end_input').attr('data-grid', 'finding');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('finding', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
