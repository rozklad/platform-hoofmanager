...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'vet');

		$('.daterangepicker_end_input').attr('data-grid', 'vet');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('vet', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
