...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'subpart');

		$('.daterangepicker_end_input').attr('data-grid', 'subpart');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('subpart', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
