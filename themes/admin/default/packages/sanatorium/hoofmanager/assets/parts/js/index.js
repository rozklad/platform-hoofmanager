...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'parts');

		$('.daterangepicker_end_input').attr('data-grid', 'parts');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('parts', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
