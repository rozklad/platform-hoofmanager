...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'examination');

		$('.daterangepicker_end_input').attr('data-grid', 'examination');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('examination', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
