...
@section('title')
@parent
{{ trans('sanatorium/hoofmanager::treatments/common.title') }}
@stop
...
{{ Asset::queue('index', 'sanatorium/hoofmanager::treatments/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/hoofmanager::treatments/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.hoofmanager.treatments.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="treatments" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="treatments" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="treatments" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="treatments" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="treatments"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.hoofmanager.treatments.grid') }}" data-grid="treatments">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/hoofmanager::treatments/model.general.id') }}}</th>
					<th class="sortable" data-sort="name">{{{ trans('sanatorium/hoofmanager::treatments/model.general.name') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('sanatorium/hoofmanager::treatments/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="treatments"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/hoofmanager::treatments/grid/index/results')
	@include('sanatorium/hoofmanager::treatments/grid/index/pagination')
	@include('sanatorium/hoofmanager::treatments/grid/index/filters')
	@include('sanatorium/hoofmanager::treatments/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/hoofmanager::treatments/help')
@endif
