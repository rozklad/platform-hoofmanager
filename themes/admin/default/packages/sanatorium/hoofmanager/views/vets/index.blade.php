...
@section('title')
@parent
{{ trans('sanatorium/hoofmanager::vets/common.title') }}
@stop
...
{{ Asset::queue('index', 'sanatorium/hoofmanager::vets/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/hoofmanager::vets/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.hoofmanager.vets.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.hoofmanager.vets.grid') }}" data-grid="vet">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/hoofmanager::vets/model.general.id') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('sanatorium/hoofmanager::vets/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	{{-- Grid: templates --}}
	@include('sanatorium/hoofmanager::vets/grid/index/results')
	@include('sanatorium/hoofmanager::vets/grid/index/pagination')
	@include('sanatorium/hoofmanager::vets/grid/index/filters')
	@include('sanatorium/hoofmanager::vets/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/hoofmanager::vets/help')
@endif
